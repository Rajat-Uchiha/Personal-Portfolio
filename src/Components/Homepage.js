...
export default function Homepage(props) {
    ...
    return (
        <>
            ...
            {/* Main section */}
            <section style={props.bgStyle} className="font-Chewy min-h-screen  text-white" id="homeSection">
                <div >
                ...
                >
                    ...
                    <div className='flex-col my-auto  w-full justify-center lg:flex lg:flex-row lg:items-center lg:justify-evenly ' >
                        ...
                        <div className="w-4/6 drop-shadow-2xl my-5 mx-auto lg:mx-4">
                            <img className="rounded-full mx-auto drop-shadow-2xl bg-stone-900 border-4 border-white" src={pic} alt="MyImage" />
                        </div>
