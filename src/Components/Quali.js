    ...
    return (
        <>
            <div style={props.bgStyle} className="bg-stone-800" >
                ...
                <div className='py-2 '>
                    <Slide left>    <h1 className='text-3xl py-2 md:text-4xl lg:text-5xl hover xl:text-5xl font-Chewy rounded-full text-center text-white  underline underline-offset-4 ' >Qualifications</h1></Slide>
                    ...
                    <Bounce left>
                        <div className='flex-col shadow-2xl border-2 border-white  justify-center lg:mx-3 xl:mx-3 py-6 mx-auto bg-stone-900 lg:w-1/2 xl:w-1/2 w-full items-center my-6 rounded-3xl' >
                            ...
                            <div className='px-4 w-4/5 mx-auto py-5' >
                                <p className='font-mono text-white text-xl' > Pursuing Bachelor of Engineering in Computer Science from Chandigarh University. Got <span className='text-lime-500' >7.88</span>  cgpa upto 3rd sem.</p>
                            </div>
                        </div>
                    </Bounce>
                    <Bounce right>
