    ...
    return (
        ...
        <>
            <div style={props.bgStyle} className="bg-stone-800">
                ...
                <div className='py-2 '>
                    <Slide left>
                        <Slide left>    <h1 className='text-3xl py-2 md:text-4xl lg:text-5xl hover xl:text-5xl font-Chewy rounded-full text-center text-white  underline underline-offset-4 ' >Technical Skills</h1></Slide>
                ...
                <div className='w-full px-2  mx-auto' >
                    <Fade top><a href="https://www.geeksforgeeks.org/html/" className=' sm:px-6 sm:flex sm:flex-row  hover:cursor-pointer flex-col mx-auto justify-evenly items-center hover:transition rounded-xl  transition duration-500 ease-in-out transform 
                    ...
                    <Fade top>  <a href="https://www.geeksforgeeks.org/Css/" className=' sm:px-6 sm:flex sm:flex-row hover:cursor-pointer  flex-col mx-auto justify-evenly items-center my-6  hover:transition rounded-xl  transition duration-500 ease-in-out transform 
                            hover:-translate-y-1 hover:scale-105' >
